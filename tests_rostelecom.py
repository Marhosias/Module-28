...
def test_registration_page_with_empty_name_field(web_browser):
    ...
    reg_page.last_name_field.send_keys("Луганский")
    reg_page.email_or_mobile_phone_field.send_keys("Asd445566@yandex.ru")
    reg_page.password_field.send_keys("Asd445566")
    reg_page.password_confirmation_field.send_keys("Asd445566")
...
def test_registration_with_an_incorrect_value_in_the_name_field(web_browser):
    ...
    auth_page.registration_link.click()
    reg_page = RegPage(web_browser, auth_page.get_current_url())
    reg_page.name_field.send_keys('П')
    reg_page.last_name_field.send_keys("Луганский")
    reg_page.email_or_mobile_phone_field.send_keys("Asd445566@yandex.ru")
    reg_page.password_field.send_keys("Asd445566")
    reg_page.password_confirmation_field.send_keys("Asd445566")
...
def test_registration_with_an_incorrect_value_in_the_last_name_field(web_browser):
    ...
    reg_page.last_name_field.send_keys("Ааааааввввввввввыыыыыыыыыфффффффффф")
    reg_page.email_or_mobile_phone_field.send_keys("Asd445566@yandex.ru")
    reg_page.password_field.send_keys("Asd445566")
    reg_page.password_confirmation_field.send_keys("Asd445566")
    reg_page.continue_button.click()
...
def test_invalid_email_or_mobile_phone(web_browser):
    ...
    reg_page.name_field.send_keys("Петр")
    reg_page.last_name_field.send_keys("Луганский")
    reg_page.email_or_mobile_phone_field.send_keys("Asd445566@yandu")
    reg_page.password_field.send_keys("Asd445566")
    reg_page.password_confirmation_field.send_keys("Asd445566")
    reg_page.continue_button.click()
...
def test_incorrect_password_during_registration(web_browser):
    ...
    reg_page.name_field.send_keys("Петр")
    reg_page.last_name_field.send_keys("Луганский")
    reg_page.email_or_mobile_phone_field.send_keys("sd445566@yandex.ru")
    reg_page.password_field.send_keys("Asd445")
    reg_page.password_confirmation_field.send_keys("Asd445")
    reg_page.continue_button.click()
...
def test_password_and_password_confirmation_do_not_match(web_browser):
    ...
    reg_page.last_name_field.send_keys("Луганский")
    reg_page.email_or_mobile_phone_field.send_keys("sd445566@yandex.ru")
    reg_page.password_field.send_keys("dsfDfd")
    reg_page.password_confirmation_field.send_keys("vbcfgg5R")
    reg_page.continue_button.click()
...
def test_password_and_password_do_not_have_capital_letters(web_browser):
    ...
    reg_page.last_name_field.send_keys("Луганский")
    reg_page.email_or_mobile_phone_field.send_keys("sd445566@yandex.ru")
    reg_page.password_field.send_keys("zxcvbnfbc")
    reg_page.password_confirmation_field.send_keys("zxcvbnfbc")
    reg_page.continue_button.click()
...
def test_negative_registration(web_browser):
    ...
    auth_page.registration_link.click()
    reg_page = RegPage(web_browser, auth_page.get_current_url())
    reg_page.name_field.send_keys("ппппппппппппппппккккккккккккккпп")
...
def test_registration_of_an_already_registered_user(web_browser):
    ...
    reg_page.name_field.send_keys("Петр")
    reg_page.last_name_field.send_keys("Луганский")
    reg_page.email_or_mobile_phone_field.send_keys("GriD69@yandex.ru")
    reg_page.password_field.send_keys("Asd445566")
    reg_page.password_confirmation_field.send_keys("Asd445566")
    reg_page.continue_button.click()
...
def test_registration_of_an_already_registered_user(web_browser):
    ...
    reg_page.name_field.send_keys("Петр")
    reg_page.last_name_field.send_keys("Луганский")
    reg_page.email_or_mobile_phone_field.send_keys("+79109173267")
    reg_page.password_field.send_keys("Asd445566")
    reg_page.password_confirmation_field.send_keys("Asd445566")
    reg_page.continue_button.click()
    assert reg_page.notification_form.is_visible
...
def test_authorization_of_a_user_with_an_invalid_password(web_browser):
    page = AuthPage(web_browser)
    page.phone.send_keys('+79109173267')
...
def test_authorisation_valid(web_browser):
    page = AuthPage(web_browser)
    page.phone.send_keys("GriD69@yandex.ru")
    page.password.send_keys("Qwe558822")
    page.btn_login.click()
...
def test_authorisation_valid(web_browser):
    page = AuthPage(web_browser)
    page.phone.send_keys("lk_dmh_30425918")
    page.password.send_keys("Qwe558822")
    page.btn_login.click()
